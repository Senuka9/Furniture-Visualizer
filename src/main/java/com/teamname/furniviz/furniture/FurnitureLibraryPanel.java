...
public class FurnitureLibraryPanel extends JPanel {
    ...
    private JList<FurnitureItem> furnitureList;
    private DefaultListModel<FurnitureItem> listModel;
    ...
    public FurnitureLibraryPanel(DesignState designState, Runnable backCallback, Runnable goTo2DEditorCallback) {
        ...
        List<FurnitureItem> items = controller.getFurnitureItems();
        if (!items.isEmpty()) {
    ...
    private JPanel createLeftPanel() {
        ...
        furnitureList.setCellRenderer(new FurnitureListCellRenderer());
        furnitureList.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                FurnitureItem selected = furnitureList.getSelectedValue();
                propertiesPanel.displayFurnitureItem(selected);
            }
        });
    ...
    private void filterFurnitureList() {
        ...
        List<FurnitureItem> allItems = controller.getFurnitureItems();
